...
class AddressController {
	...
	function getDistricts() {
		...
		$districts = $districtRepository->getByProvinceId($province_id); // Object
		//  $this->convertToAssociateArray($districts): array 
		echo json_encode($this->convertToAssociateArray($districts)); // String, gửi lại cho client
	}
