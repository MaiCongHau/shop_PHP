                 ...
                 <div class="row">
                     <div class="col-md-3 col-sm-3 col-xs-4 list">
                         <div class="footerLink">
                             <h4>Danh mục</h4>
                             <?php $category = new CategoryRepository;
                                       $footercategory =  $category->getAll();
                                      foreach ($footercategory  as $key => $value):?>
                             <ul class="list-unstyled">
                                 <li><a href="#"><?=$value->getName()?></a></li>
                             </ul>
                             <?php endforeach ?>
                         </div>
                     </div>
                     ...
                     <div class="col-md-3 col-sm-3 col-xs-4 list">
                         <div class="footerLink">
                             ...
                             <ul class="list-unstyled">
                                 <li>Phone: 0774748800</li>
                                 <li><a href="mailto:maiconghau263@gmail.com">Mail:
         ...
         <div class="modal-content">
             ...
             <form class="form-register" action="index.php?c=register&a=create" method="POST" role="form">
                 <div class="modal-body">
                     ...
                     <div class="form-group g-recaptcha" data-sitekey="6LcBTL0gAAAAAL7QEJtd4cNvYmbgdp19c1ES_DO3"></div> <!--tên miền ảo-->
         ...
         <div class="modal-content">
             <div class="modal-header bg-color">
                 ...
                 <?php
                        ...
                        $redirectUri =  get_domain() . $_SERVER['PHP_SELF'] . "?c=auth&a=loginGoogle";// dùng để callback về mình để add cái account
                          
                        // create Client Request to access Google API
                        $client = new Google_Client();
                        $client->setClientId($clientID); // là CLIENT_ID
                        $client->setClientSecret($clientSecret); // _SECRET
                        $client->setRedirectUri($redirectUri); // để callback lấy thông tin 
                        $client->addScope("email"); // lấy tên email của người dùng
                        $client->addScope("profile"); // lấy profile của người dùng
                        $loginUrl = $client->createAuthUrl(); 
// $loginUrl sẽ sinh ra cho ta đường link đăng nhập với google 
// https://accounts.google.com/o/oauth2/auth/oauthchooseaccount?response_type=code&access_type=online&client_id=972762379370-onohoecdb3bpgljtq7t06278d6okq6cn.apps.googleusercontent.com&redirect_uri=https%3A%2F%2Fshop.com%2Fsite%2Findex.php%3Fc%3Dauth%26a%3DloginGoogle&state&scope=email%20profile&flowName=GeneralOAuthFlow
// gắn nó vô nút đăng nhập google là xong
                        ?>
                 <br>
                 <div class="text-center">
                     <a class="btn btn-primary google-login" href="<?=$loginUrl?>"><i class="fab fa-google"></i></i> Đăng nhập bằng
                         Google</a>
                      <!-- Facebook login -->
                      <?php
                            ...
                            ?>
                     <a class="btn btn-primary facebook-login" href="<?=$loginUrl?>"><i class="fab fa-facebook-f"></i> Đăng nhập bằng
                         Facebook</a>
                 </div>
             </div>
             <form action="?c=login&a=form" method="POST" role="form">
                 <div class="modal-body">
                     <div class="form-group">
