...
<main id="maincontent" class="page-main">
    <div class="container">
        <div class="row">
            ...
            <?php require ABSPATH_SITE. "sidebar.php" ?>
                    ...
                    <div class="col-md-6">
                        <form class="info-account" action="index.php?c=customer&a=updateInfo" method="POST" role="form">
                            <div class="form-group">
                                <input type="text" value="<?=$customer->getName()?>" class="form-control" name="fullname"
                                    placeholder="Họ và tên" required=""
                                    oninvalid="this.setCustomValidity('Vui lòng nhập tên của bạn')"
                                    oninput="this.setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                <input type="tel" value="<?=$customer->getMobile()?>" class="form-control" name="mobile"
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" name="re_password"
                                    placeholder="Nhập lại mật khẩu mới" required oninvalid="this.setCustomValidity('Vui lòng nhập ít nhất 8 ký tự: số, chữ hoa, chữ thường')"
                                    oninput="this.setCustomValidity('')">
                            </div>
                            <div class="form-group">
