            ...
            <div class="col-md-9 product-detail">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="product-detail-carousel-slider">
                            <div class="owl-carousel owl-theme">
                                ...
                                <?php foreach($product->getImageItems() as $getImageItem): ?>
                                <div class="item thumbnail"><img src="../upload/<?=$getImageItem->getName()?>" alt="">
                                </div>
                                <?php endforeach?>
                    ...
                    <div class="col-md-6">
                        <h5 class="product-name"><?=$product->getName()?>
                            ...
                            <div class="product-item-price">
                                ...
                                <span class="product-item-regular"><?=number_format($product->getSalePrice())?></span>
                                <?php endif ?>
                            ...
                            <div class="input-group">
                                ...
                                <a href="javascript:void(0)" product-id="<?=$product->getId()?>"
                                    class="buy-in-detail btn btn-success cart-add-button <?=$product->getInventoryQty()==0?"disabled":""?> ">
                                ...
                                <div role="tabpanel" class="tab-pane" id="product-comment">
                                    ...
                                    <div class="comment-list">
                                        ...
                                        <?php $comments= $product -> getComments()?>
                                         <?php require ABSPATH_SITE. "layout/comments.php" ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row product-related equal">
                    <div class="col-md-12">
                        ...
                        <div class="owl-carousel owl-theme">
                            <?php foreach ($relatedProducts as $key => $product) :?>
