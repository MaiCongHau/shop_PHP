<?php 
 ...
 //ABSPATH_SITE: shop/site/
  ...
  require_once ABSPATH . "service/MailService.php";
...
//    http://shop.com/danh-muc/index.php?
//    sort=price-desc
// lấy tới trước dấu "?" thôi, còn sau dấu ? ko lấy 
// $_SERVER['REQUEST_URI']: /danh-muc/index.php?sort=price-desc
// $uri_parts[0] : /danh-muc/index.php?sort=price-desc
// $uri_parts[1] : sort=price-desc
